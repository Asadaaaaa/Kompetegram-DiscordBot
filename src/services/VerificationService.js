...
class VerificationService {
  ...
  async sendVerifMail(email,  userTag, userId) {
    ...
    if(this.server.data.tempVerif[userId].verifCode === null) {
      this.server.data.tempVerif[userId].verifCode = verifCode;
    } else {
      return;
    }
    ...
    const data = await transporter.sendMail({
      from: '"Kompetegram Discord" <kompetegram.verif@gmail.com>',
      to: email,
      subject: 'Kompetegram Discord Verification',
      attachments: [
        {
          filename: 'kompetegram.png',
          path: 'https://raw.githubusercontent.com/Asadaaaaa/Kompetegram-DiscordBot/main/src/resources/assets/kompetegram.png',
          cid: 'logo'
        }
      ],
      ...
      * {
      ...
      <body class="clean-body u_body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #c9c9c9;color: #000000">
        ...
        <table style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #c9c9c9;width:100%" cellpadding="0" cellspacing="0">
        <tbody>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
            ...
            <img align="center" border="0" src="cid:logo" alt="Logo" title="Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 50%;max-width: 290px;" width="290" class="v-src-width v-src-max-width"/>
      ...
      <table id="u_content_heading_1" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        <tbody>
          <tr>
            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 30px 15px 31px;font-family:arial,helvetica,sans-serif;" align="left">
      ...
      <table id="u_content_text_2" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        <tbody>
          <tr>
            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 55px 10px;font-family:arial,helvetica,sans-serif;" align="left">
              
        <div class="v-text-align" style="color: #333333; line-height: 180%; text-align: left; word-wrap: break-word;">
          <p style="font-size: 14px; line-height: 180%;"><span style="font-size: 18px; line-height: 32.4px; font-family: Lato, sans-serif;"><strong><span style="line-height: 32.4px; font-size: 18px;">Hi ${userTag}, </span></strong></span></p>
      <p style="font-size: 14px; line-height: 180%;"><span style="font-family: Lato, sans-serif; font-size: 16px; line-height: 28.8px;">Lakukan verifikasi anggota server discord kompetegram dengan menggunakan kode dibawah ini: </span><span style="font-family: Lato, sans-serif; font-size: 16px; line-height: 28.8px;"></span></p>
        </div>
      ...
      <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="color: #ffffff; line-height: 210%; text-align: center; word-wrap: break-word;">
          <p style="font-size: 14px; line-height: 210%;"><span style="font-family: Lato, sans-serif; font-size: 14px; line-height: 29.4px;">kompetegram.com</span></p>
        </div>
